...
class ReasonerTests(unittest.TestCase):
    def test_reasoner_emits_expected_schema(self) -> None:
        ...
        self.assertEqual(events[0]["axis7"]["family"], 7)
        self.assertEqual(events[0]["axis7"]["tick"], 0)
        self.assertEqual(events[0]["axis7"]["rel16"], "3")
        self.assertEqual(events[0]["axis240"]["family"], 240)
        self.assertEqual(events[0]["axis240"]["slot"], 0)
        self.assertEqual(events[0]["axis240"]["path"], "m/orbit/0/part/1/dialect/test/chain/2")
        self.assertEqual(events[0]["axis256"]["family"], 256)
        self.assertEqual(events[0]["axis256"]["curr8"], "01")
        self.assertEqual(events[0]["axis256"]["curr6"], "01")
        self.assertEqual(events[0]["axis256"]["frame32"], "0101")
